...
public class ChannelSaveRequestDto {
    ...
    @Builder
    public ChannelSaveRequestDto(Long ch_no, String id, String pw, String name, String nickname, String img, String link, String msg, String poster, Role role, List<String> interests, Long searchFrequency) {
        this.ch_no = ch_no;
        this.id = id;
        this.pw = pw;
        this.name = name;
