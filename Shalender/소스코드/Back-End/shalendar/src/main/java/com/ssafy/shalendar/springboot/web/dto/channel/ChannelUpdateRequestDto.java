...
public class ChannelUpdateRequestDto {
    ...
    @Builder
    public ChannelUpdateRequestDto(Long ch_no, String id, String pw, String name, String nickname, String img, String link, String msg,String poster, Role role, Long searchFrequency) {
        this.ch_no = ch_no;
        this.id = id;
        this.pw = pw;
        this.name = name;
